...
interface MarkdownReader {
  fun read(@RawRes rawResId: Int): AnnotatedString
}

@ContributesBinding(AppScope::class, MarkdownReader::class)
class RealMarkdownReader @Inject constructor(
  ...
  private fun AnnotatedString.Builder.heading(text: String, sp: Int) {
    withStyle(
      ParagraphStyle(
  ...
  private fun Resources.readLines(@RawRes rawResId: Int, block: (String) -> Unit) {
